 ...
 * preview is the point — you can see before you send it that your notes are
 * not in there.
 */
...
export function DayShot({
  ...
  const canvas = useMemo(
    () => drawDay({ day, shape, schedule, dailyGoal }, scale),
    [day, shape, schedule, dailyGoal, scale],
  );
      ...
      <div className="shot">
        ...
        <div className="shot__side">
          <p className="muted small">
            The shape of the day only — hours, blocks and their verdicts. Your comments, side
            notes and round goals are never drawn.
          </p>
